# ⏲️ Pomodoro App (Figma Prototype)
...
- **Clarity:** Users understand each option instantly.  
- **Speed:** The routine can be created in just a few taps/clicks.  
- **Simplicity:** Only essential configuration elements are included, avoiding unnecessary complexity.
